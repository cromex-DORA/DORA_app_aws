...
class Bloc:
    ...
    #merge pour le type d'action en fonction de la pression
        ...
        self.df.to_csv("G:/travail/carto/projets basiques/PAOT global 5.0/Tableau actions/MIA/MO/tableaux_tempo/df_brouillon_apres_conv_type_action.csv")
        return self
...
##########################################################################################
    ...
    def placement_point_icone_dans_bloc_lm(self):
        ...
        #self.df_indiv.to_file("G:/travail/carto/projets basiques/PAOT global 5.0/test/test_bloc_lm.shp", encoding='utf-8')        
        return self
