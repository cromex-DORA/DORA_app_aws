...
##########################################################################################
    ...
    def mise_ordre_col_maj_osmose(self):
        df_maj_vierge = pd.read_excel("G:/travail/carto/projets basiques/PAOT global 5.0/config/Osmose/TABLEAU_MAJ_OSMOSE_VIERGE.xlsx")
    ...
    def renommage_col(df):
        ...
        df.to_csv("G:/travail/carto/couches de bases/test/allo.csv")
