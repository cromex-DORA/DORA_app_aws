        ...
        for nom_entite_custom,contenu_custom in self.items():
            for type_boite,contenu_boite in contenu_custom.items():
                if contenu_boite.orientation=="normal":
                    contenu_boite.df_fleche = contenu_boite.df_fleche.to_file("G:/travail/carto/projets basiques/PAOT global 5.0/"+ id_projet +"/couche_fleche/fleche_" + id_projet +".shp",engine="fiona", encoding='utf-8')
