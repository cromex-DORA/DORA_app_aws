...
def export_fichier_excel_recherche_SANDRE(df_recherche,BDD_SIRET,df_info_GEMAPI_sans_CODE_SIRET):
    excel_modif = load_workbook("G:/travail/carto/couches de bases/syndicats GEMAPI/recherche_SANDRE.xlsx", read_only=False)
    '''excel_modif.save("G:/travail/carto/couches de bases/syndicats GEMAPI/recherche_SANDRE_0.xlsx")
    excel_modif = load_workbook("G:/travail/carto/couches de bases/syndicats GEMAPI/recherche_SANDRE_0.xlsx", read_only=False)'''
