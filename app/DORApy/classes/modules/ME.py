...
def import_shp_ME_LB(self):
    #couche PPG
    shp_ME = gpd.read_file("G:/travail/carto/couches de bases/ME/BV ME sup LB 2021.shp")
    shp_ME = shp_ME.to_crs(2154)
    #On calmes les ardeurs des LB
    shp_clipping = gpd.read_file("G:/travail/carto/couches de bases/ME/couche_clipping_pour_diminuer les ME_LB.shp")
...
def creation_df_chainage_ME_aval():
    df_chainage = pd.read_csv("G:/travail/carto/couches de bases/ME/chainage_BV_ME_AG_2022.csv")
